...
function App() {
  ...
  useEffect( () => {
	passwordGenerator();
  }, [ length, numberAlowed, charAllowed, passwordGenerator ] )
	  ...
	  <div className="w-full max-w-md mx-auto shadow-md text-orange-500 rounded-lg my-8 px-4 py-3 bg-gray-700">
		...
		<div className="flex shadow rounded-lg overflow-hidden mb-4">
			<input 
				...
				ref={passwordRef}
			/>
			<button className="bg-blue-700 text-white outline-none px-3 py-1 shrink-0" onClick={copyPassToClipboard}>Copy</button>
		</div>
